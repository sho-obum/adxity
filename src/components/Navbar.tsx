...
export const Navbar = () => {
  ...
  // Enhanced dropdown content with purple-themed colors
      ...
      {items.map((item, index) => (
        <a
          ...
          className={`group flex items-start gap-4 p-4 rounded-xl hover:bg-white/5 transition-all duration-300 transform hover:scale-[1.02] ${
            isMobile ? "hover:bg-purple-500/10" : ""
          }`}
        >
          <div
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-white font-medium text-sm group-hover:text-purple-200 transition-colors">
              {item.name}
            </h3>
          ...
          <svg
            className="w-4 h-4 text-gray-400 group-hover:text-purple-200 group-hover:translate-x-1 transition-all duration-300"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
          ...
          <nav className="hidden md:flex text-white gap-6 items-center ml-auto">
            ...
            >
              ...
              {activeDropdown === "Publishers" && (
                ...
                >
                  <div
                    className="relative rounded-2xl border border-purple-500/30 shadow-2xl overflow-hidden"
                    style={{
                  ...
                  >
                    <div className="absolute inset-0 bg-gradient-to-br from-purple-500/20 via-violet-500/10 to-transparent pointer-events-none" />
                    ...
                    <div className="relative p-6">
                      ...
                      <div className="pt-4 mt-4 border-t border-purple-500/30">
                        <a
                          href="#"
                          className="inline-flex items-center gap-2 text-sm text-purple-300 hover:text-purple-200 transition-colors font-medium"
                        >
              ...
              <div>
                ...
                {mobileDropdown === "Publishers" && (
                  <div className="mt-2 mx-4 animate-in fade-in-0 slide-in-from-top-2 duration-300">
                    <div
                      className="relative rounded-xl border border-purple-500/30 shadow-xl overflow-hidden"
                      style={{
                    ...
                    >
                      <div className="absolute inset-0 bg-gradient-to-br from-purple-500/15 via-violet-500/8 to-transparent pointer-events-none" />
